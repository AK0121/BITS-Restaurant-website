    ...
    <section className="pt-24 pb-12 sm:pt-40 lg:pb-20 bg-white">
      <div className="max-w-7xl mx-auto px-6 md:px-16 flex flex-col-reverse lg:flex-row items-center gap-36 lg:gap-16">
        ...
        <div className="w-full lg:w-1/2 space-y-3 text-center lg:text-left">
          <h4 className={`text-sm md:text-lg font-semibold text-[var(--color-primary)] uppercase tracking-wide ${montserrat.className}`}>
            Our Story
          </h4>
          <h2 className="text-4xl font-bold text-[RGB(8, 7, 15)]">About Us</h2>
          <p className={`text-[#6B6F72] leading-relaxed pt-2 text-[16px] line-h-2.5 ${poppins.className} tracking-wide lg:tracking-wider`} >
            At Vijay Restaurant, we believe in the power of flavors to transport you
            on a culinary journey like no other. Nestled in the heart of the BITS Pilani,
            our restaurant is a haven for food enthusiasts seeking an unforgettable
            dining experience that tantalizes the senses and captures the essence of
            world cuisine.
          </p>
