    ...
    <div>
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          >
            At Vijay Restaurant, we believe in the power of flavors to transport you on a culinary journey like no other. Nestled in the heart of the campus, our restaurant is a haven for food enthusiasts seeking an unforgettable dining experience that tantalizes the senses and captures the essence of world cuisine.
          </motion.p>
        </div>
        ...
        >
          <div className="flex space-x-8 text-sm font-medium">
            ...
            <p className="text-white">FOOD GALLERY</p>
          </div>
        </motion.nav>
      </motion.section>
      <motion.div
