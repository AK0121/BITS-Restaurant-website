...
export default function Home() {
  ...
  return (
    <>
      <section className="relative w-full h-screen lg:h-[90vh] mt-20 bg-white overflow-hidden">
        ...
        <MotionImage
          ...
          width={200}
          priority
          className="absolute -bottom-6 right-64 lg:right-[20rem] h-auto w-80 lg:w-xl object-contain z-0"
        />
        <MotionImage
          initial={{ y: -120 }}
          animate={{ y: 0 }}
        ...
        <div className="font-body relative z-10 max-w-7xl mx-auto px-16 md:pt-48 pt-32 flex flex-col lg:flex-row items-center md:justify-between justify-center gap-1 lg:gap-12">
          ...
          <div className="flex flex-col justify-center pt-0 sm:pt-10 items-center lg:justify-start lg:items-start gap-8 w-full lg:w-1/2">
            ...
            >
              At Vijay Restaurant, we believe in the power of flavors to
          ...
          {/* Hero Dish Image */}
          <div className="relative top-0 z-50 w-96 h-96 lg:w-[28rem] lg:h-[28rem] flex justify-center mr-0 lg:mr-20">
            <PaneerBowl />
          </div>
        </div>
      </section>
